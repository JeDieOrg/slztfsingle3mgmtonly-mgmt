...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "slz-identity-tf-mgmt-only-single3"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "slz-connectivity-tf-mgmt-only-single3"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "slz-management-tf-mgmt-only-single3"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "slz-security-tf-mgmt-only-single3"
    }
  }
  policy_assignments_to_modify = {
    slz-tf-mgmt-only-single3 = {
      policy_assignments = {
    ...
    slz-connectivity-tf-mgmt-only-single3 = {
      policy_assignments = {
        Enable-DDoS-VNET = {
    ...
    slz-landingzones-tf-mgmt-only-single3 = {
      policy_assignments = {
        Enable-DDoS-VNET = {
          creation_enabled = false
        }
